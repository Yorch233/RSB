...
if ! ${METRICS_ONLY}; then
    ...
    python -m cli.inference \
        ...
        --audio_path "/root/autodl-tmp/dataset/wsj0_wham/audio/tt/noisy/" \
...
python -m cli.calc_metric \
    --clean_dir "/root/autodl-tmp/dataset/wsj0_wham/audio/tt/clean/" \
    --noisy_dir "/root/autodl-tmp/dataset/wsj0_wham/audio/tt/noisy/" \
