...
from RSB.utils.paths import DNSMOS_MODEL_DIR, DNSMOS_PERSONALIZED_MODEL_DIR
...
def main(args):
    ...
    p808_model_path = DNSMOS_MODEL_DIR / "model_v8.onnx"

    if args.personalized_MOS:
        primary_model_path = DNSMOS_PERSONALIZED_MODEL_DIR / "sig_bak_ovr.onnx"
    else:
        primary_model_path = DNSMOS_MODEL_DIR / "sig_bak_ovr.onnx"
